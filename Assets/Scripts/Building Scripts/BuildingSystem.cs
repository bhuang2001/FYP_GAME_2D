...
public class BuildingSystem : MonoBehaviour
{
    ...
    private void Update()
    {
        ...
        {
            ClearArea();
            if (temp.gameObject.CompareTag("Router"))
            {
                routerNum--;
            }
            else if (temp.gameObject.CompareTag("Host"))
            {
                hostNum--;
            }
    ...
    public void InitializeRouter (GameObject entity)
    {
        ...
        public void InitializeHost (GameObject entity)
    {
